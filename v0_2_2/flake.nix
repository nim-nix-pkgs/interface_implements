{
  ...
  inputs.src-interface_implements-v0_2_2.ref   = "v0_2_2";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-interface_implements-v0_2_2"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-interface_implements-v0_2_2";
